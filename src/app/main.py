...
from app.database import check_db_operations, init_db
...
async def get_result(task_id: str):
    ...
    # Get job info
    cursor.execute(
        """ SELECT file_name, start_datetime, end_datetime, status,
                    width, height FROM jobs WHERE uuid = ? """,
        (task_id,),
    )
